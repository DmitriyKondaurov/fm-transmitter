...
if (!class_exists('Inbound_GA_Admin_Settings')) {
	...
	class Inbound_GA_Admin_Settings {
		...
		public static function enqueue_scripts() {
			...
			if (isset($screen->base) && ($screen->base != 'toplevel_page_inbound-ga-settings' && $screen->base != 'inbound-now_page_inbound-ga-settings'&& $screen->base != 'inbound-pro_page_inbound-ga-settings')) {
				return;
			}
			...
			<section id="step01">
				...
				<div class="section_content active">
					<form action="" method="post">
						...
						<ol>
							<li>Visit
								<a href="https://www.inboundnow.com/link-google-analytics-profile-website/" rel="">How
									to connect Google Analytics to Inbound Now</a> for complete tutorial.
							</li>
							<li>Visit <a href="https://console.developers.google.com/" rel="nofollow">https://console.developers.google.com/</a>
								and create a new project.
							</li>
							<li>Enable the API for Google Analytics</li>
							<li>Create a oauth credentials and set the following as your redirect
								URI:<?php echo admin_url('edit.php?inbound_ga_oauth=1'); ?></li>
			...
			<section id="step02">
				...
				<div class="section_content active">
					...
					Google account must have access to analytics.</p>', 'inbound-pro'); ?>
						<p>
							<a class="btn btn-primary btn-large" href="<?php echo $google_oauth->loginurl ?>"><?php _e('Authorize with Google account', 'inbound-pro'); ?></a>
						</p>
		...
		public static function display_step_2_select_profiles() {
			...
			$checked = (isset(self::$ga_settings['disable_tracking_insert']) && self::$ga_settings['disable_tracking_insert']) ? self::$ga_settings['disable_tracking_insert'] : false;
			?>
			<section id="step02">
				<div class="section_title">
				...
				<div class="section_content active">
					<div class="hero-unit">
						...
						<i>
							<small><?php _e('This extension automatically adds Google Universal Analytics tracking code to your theme\'s footer.', 'inbound-pro'); ?></small>
						</i>
						<br>

						<input name="disable_tracking_insert" id="disable_tracking_insert" type="checkbox" value="1" <?php echo ($checked == 'true') ? 'checked="true"' : ''; ?> ><?php _e('Click to disable automatic insertion of tracking code', 'inbound-pro'); ?>
				...
				<div class="section_content active">
					<div class="hero-unit">
						<form action="" method="post">
							...
							<br>
							<i>
								<small><?php _e('If you have not added your Google Analytics JS snippet to your website yet you can add it in here.', 'inbound-pro'); ?></small>
							</i>
		...
		public static function define_pro_settings($settings) {
			$settings_url = add_query_arg(array('page' => 'inbound-ga-settings'), admin_url('admin.php'));
			$html = '<a href="' . $settings_url . '" class="ink-button green" target="_blank">' . __('Authorization Setup', 'inbound-pro') . '</a>';

			$settings['inbound-pro-settings'][] = array(
				'group_name' => INBOUND_GA_SLUG,
				'keywords' => __('google,inbound-google-analytics,analytics', 'inbound-pro'),
				'fields' => array(
					array(
						'id' => 'header_ga',
						'type' => 'header',
						'default' => __('Google Analytics', 'inbound-pro'),
						'options' => null
					),
					array(
						'id' => 'header_ga_settings_link_html',
						'type' => 'html',
						'default' => $html,
						'description' => ''
					),
					array(
						'id' => 'reports_quick_view',
						'type' => 'radio',
						'default' => '1',
						'label' => __( 'Load Impression/Visitors from Google Analytics' ,'inbound-pro'),
						'description' => __('Turning this setting to on will pull impression and visitor stats from Google Analytics instead of using Inbound Now data. This will not affect Landing Page, Call to Action, or Email statistics.','inbound-pro'),
						'options' => array(
							'0' => __('off','inbound-pro'),
							'1' => __('on','inbound-pro'),
						)
					)
				)
		...
		/**
		 * Switches Quick View Template to a GA Analytics mode.
		 * @param $template
		 */
		public static function switch_quick_view_template($template_class) {
			global $inbound_settings;

			$switch =  (isset($inbound_settings['inbound-google-analytics']['reports_quick_view'])) ? $inbound_settings['inbound-google-analytics']['reports_quick_view'] : 1;

			if ( (int)$switch ) {
				return 'Google_Anlytics_Quick_View';
			} else {
