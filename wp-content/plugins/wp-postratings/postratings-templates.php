...
/* <![CDATA[*/
	function ratings_updown_templates(template, print) {
		...
		switch(template) {
			case "vote":
				...
				break;
			case "text":
				default_template = "%RATINGS_IMAGES% (<em><strong>%RATINGS_SCORE%</strong> <?php esc_html_e('rating', 'wp-postratings'); ?><?php esc_html_e(',', 'wp-postratings'); ?> <strong itemprop=\"ratingCount\">%RATINGS_USERS%</strong> <?php esc_html_e('votes', 'wp-postratings'); ?><?php esc_html_e(',', 'wp-postratings'); ?> <strong><?php esc_html_e('rated', 'wp-postratings'); ?></strong></em>)";
				break;
			case "permission":
	...
	function ratings_default_templates(template, print) {
		...
		switch(template) {
            ...
            <?php esc_html_e('votes', 'wp-postratings'); ?><?php esc_html_e(',', 'wp-postratings'); ?> <?php
            esc_html_e('average', 'wp-postratings'); ?>: <strong itemprop=\"ratingValue\">%RATINGS_AVERAGE%</strong> <?php esc_html_e('out of', 'wp-postratings');
                ?>  <span itemprop=\"bestRating\"> %RATINGS_MAX%)</span><br />%RATINGS_TEXT%";
				break;
			case "text":
				default_template = "%RATINGS_IMAGES% (<em><strong itemprop=\"ratingCount\">%RATINGS_USERS%</strong> <?php esc_html_e('votes', 'wp-postratings'); ?><?php esc_html_e(',', 'wp-postratings'); ?> <?php esc_html_e('average', 'wp-postratings'); ?>: <strong itemprop=\"ratingValue\">%RATINGS_AVERAGE%</strong> <?php esc_html_e('out of', 'wp-postratings'); ?> <span itemprop=\"bestRating\"> %RATINGS_MAX%</span><?php esc_html_e(',', 'wp-postratings'); ?> <strong><?php esc_html_e('rated', 'wp-postratings'); ?></strong></em>)";
				break;
			case "permission":
				default_template = "%RATINGS_IMAGES% (<em><strong itemprop=\"ratingCount\">%RATINGS_USERS%</strong> <?php esc_html_e('votes', 'wp-postratings'); ?><?php esc_html_e(',', 'wp-postratings'); ?> <?php esc_html_e('average', 'wp-postratings'); ?>: <strong itemprop=\"ratingValue\">%RATINGS_AVERAGE%</strong> <?php esc_html_e('out of', 'wp-postratings'); ?> <span itemprop=\"bestRating\"> %RATINGS_MAX%</span></em>)<br /><em><?php esc_html_e('You need to be a registered member to rate this.', 'wp-postratings'); ?></em>";
				break;
			case "none":
				default_template = "%RATINGS_IMAGES_VOTE% (<?php esc_html_e('No Ratings Yet', 'wp-postratings'); ?>)<br />%RATINGS_TEXT%";
				break;
