...
/* <![CDATA[*/
	...
	function ratings_default_templates(template, print) {
		...
		switch(template) {
			case "vote":
				default_template = "%RATINGS_IMAGES_VOTE% (<strong itemprop=\"ratingCount\">%RATINGS_USERS%</strong> <?php esc_html_e('votes', 'wp-postratings'); ?><?php esc_html_e(',', 'wp-postratings'); ?> <?php esc_html_e('average', 'wp-postratings'); ?>: <strong>%RATINGS_AVERAGE%</strong> <?php esc_html_e('out of', 'wp-postratings'); ?> %RATINGS_MAX%)<br />%RATINGS_TEXT%";
				break;
			case "text":
