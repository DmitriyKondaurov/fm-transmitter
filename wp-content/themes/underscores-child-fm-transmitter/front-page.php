                ...
                <div class="wrapper">
                    ...
                    <div class="hero_main">
                        ...
                        <ul itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating"
                            ...
                            <?php if(function_exists('the_ratings')) { echo process_ratings($post_ratings_users); }
                                ?></span>
                            <span itemprop="ratingValue">
                            <?php if(function_exists('the_ratings')) { echo process_ratings($post_ratings_average); }
	                            ?></span>
                            <span itemprop="bestRating">
                            <?php if(function_exists('the_ratings')) { echo process_ratings($ratings_max); }
	                        ?></span>
                        </ul>
